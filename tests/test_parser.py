...
class TestClifParser(unittest.TestCase):
    ...
    def test_parse_nested_expression(self):
        ...
        # Verification:
        # 1. Find the P and Q predicates and the Cut
        ...
        # 2. Check their locations are correct (P on SA, Q inside the Cut)
        ...
        # 3. Crucially, check that both P and Q are connected to the SAME Line of Identity
        self.assertIsNotNone(p_pred.hooks[1])
        self.assertEqual(p_pred.hooks[1], q_pred.hooks[1])
        
        # 4. Check the parser's internal variable map is correct
